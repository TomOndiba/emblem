						        ...
						        <div class="clearfix">
						            <div class="well" >
						                <ul id="grid" class="media-grid">
						                    ...
						                    <li>
						                        <div class="grid-item">
						                            <img src="<?php echo base_url($image->thumb_url) ?>"></img>
...
<script type="text/javascript">
    ...
    function createUploader(){           
        var uploader = new qq.FileUploader({
            ...
            action: '<?php echo base_url('index.php/ajax/multiple_upload_ajax'); ?>',
            debug: true,
    ...
    function addPhotoDb(image_url, image_name ){
    	...
    	$.post(
    		"<?php echo base_url('index.php/ajax/addPhotoDb_ajax'); ?>",
    		{ 
    ...
    function addImageCallBack(data){
        if(data.success){ 
            ...
            var img = $('<img>');
            img.attr('src', '<?php echo base_url(); ?>'+'/'+data.img_url);
            div.append(img);
    ...
    function deleteImage(id){
        $.get('<?php echo base_url('index.php/ajax/deleteImage_ajax'); ?>', { id : id}, deleteImageCallBack, 'json' );
        return false;   
    }
