				...
				<div id="adminbody-content">
					...
					<div class="wrap">
						...
						<div class='left'>
							...
							<br/><br/>
							<p>Title: </p>
							<input type='text' name='title' id='title' placeholder='Enter dish title here' />
							<br/><br/>
							<p>Název: </p>
							<input type='text' name='title_cz' id='title_cz' placeholder='Zadejte parabolu titul tady' />
							<br/><br/>
							<p>Ingredients (description): </p>
							<textarea rows="7" name='desc' id='desc' placeholder='Enter description here'></textarea>
							<br /><br/>
							<p>Složení: </p>
							<textarea rows="7" name='desc_cz' id='desc_cz' placeholder='Zadejte popis zde'></textarea>
							<br /><br/>
							<p>Cena / price: </p>
							<input type='text' name='price' id='price' placeholder='Zadejte cena zde' />
							<br />
							<br />
							<input class="btn primary transition" type="button" onclick="createDish()" value="Create">
...
<script type="text/javascript">
    ...
    function createDish()
    {
    	...
    	$.ajax({
    		type: "POST",
	        url: "../index.php/ajax/create_dish",
	        dataType: "json",
	        data: "title="+title+"&title_cz="+title_cz+"&desc="+desc+"&desc_cz="+desc_cz+"&price="+price+"&category="+category,
	        cache:false,
	        success: 
	          function(data){
